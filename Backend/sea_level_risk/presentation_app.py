    ...
    if spotlight_impact:
        ...
        if rollup_rows:
            ...
            e4.metric(
                ...
                "n/a"
                if spotlight_impact.get("high_vulnerability_population_affected_estimate") in {None, 0}
                else f"{int(spotlight_impact['high_vulnerability_population_affected_estimate']):,}",
            )
